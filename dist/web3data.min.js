(function (global, factory) {
  ...
  const {is: is$4, get: get$4, onFulfilled: onFulfilled$3, onError: onError$3, throwIf: throwIf$2} = utils$1;
  ...
  class Transaction {
    ...
    getTransaction(hash, filterOptions) {
      throwIf$2(is$4.notHash(hash), NO_HASH);
      return get$4(this.web3data, {
        pathParam: hash,
        endpoint: ENDPOINT$3,
        filterOptions
    ...
    getPendingTransactions() {
      return this.getTransactions({status: 'pending'}).then(
        pendingTransactions => {
          throwIf$2(
            is$4.undefined(pendingTransactions) || is$4.null(pendingTransactions),
  ...
  class Block {
    ...
    getBlocks(filterOptions) {
      return get$5(this.web3data, {
        endpoint: ENDPOINT$4,
        filterOptions
      }).then(onFulfilled$4.bind({formatter: recordsFormatter$1}), onError$4)
    }
  ...
  const {is: is$7, get: get$7, throwIf: throwIf$4, onFulfilled: onFulfilled$5, onError: onError$5} = utils$1;
  const {
