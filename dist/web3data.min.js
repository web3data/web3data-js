(function (global, factory) {
  ...
  const {is: is$1, get: get$1, throwIf: throwIf$1, onFulfilled: onFulfilled$1, onError: onError$1} = utils$1;
  ...
  const {is: is$3, get: get$3, throwIf: throwIf$2, onFulfilled: onFulfilled$3, onError: onError$3} = utils$1;
  ...
  const {is: is$4, get: get$4, onFulfilled: onFulfilled$4, onError: onError$4} = utils$1;
  ...
  class Block {
    ...
    getBlocks(filterOptions) {
      return get$5(this.web3data, {
        endpoint: ENDPOINT$4,
        filterOptions
      }).then(onFulfilled$5.bind({formatter: recordsFormatter$1}), onError$5)
    }
    ...
    getBlock(id, filterOptions) {
      throwIf$3(is$5.undefined(id), NO_BLOCK_ID);
      return get$5(this.web3data, {
        pathParam: id,
        endpoint: ENDPOINT$4,
        filterOptions
    ...
    getBlockNumber() {
      return this.web3data.block.getBlock('latest').then(block => {
        throwIf$3(block | !block.number, 'Failed to retrieve block number.');
    ...
    getTransactionFromBlock(id, index) {
      ...
      return this.web3data.block.getTransactions(id).then(txns => {
        throwIf$3(!txns, 'Failed to retrieve transaction.');
    ...
    getUncle(id, index) {
      throwIf$3(is$5.undefined(id), NO_BLOCK_ID);
      throwIf$3(is$5.undefined(index), "Missing required param 'index'");
  ...
  const {is: is$7, get: get$7, throwIf: throwIf$4, onFulfilled: onFulfilled$6, onError: onError$6} = utils$1;
  const {
  ...
  class Market {
    ...
    async getEtherPrice() {
      ...
      }).then(response => response.payload.eth_usd.price, onError$6)
    }
    ...
    getFeatures(features = FEATURES, filterOptions = {}) {
      ...
      features = features.map(feature => {
        ...
        throwIf$4(is$7.undefined(feature) || !FEATURES.includes(feature), NO_FEATURE);
    ...
    getOhlcv(pair, filterOptions = {}) {
      throwIf$4(is$7.undefined(pair), NO_MARKET_PAIR);
      const subendpoint =
    ...
    getOrders(pair, exchange, filterOptions = {}) {
      ...
      exchange.forEach(exchange =>
        throwIf$4(is$7.undefined(exchange), 'No exchange specified')
      );
    ...
    getPrices(base, filterOptions = {}) {
      throwIf$4(is$7.undefined(base), NO_MARKET_PAIR);
      const subendpoint =
        filterOptions.startDate || filterOptions.endDate ? 'historical' : 'latest';
      return get$7(this.web3data, {
        pathParam: base,
    ...
    getTokenPrices(hash, filterOptions = {}) {
      throwIf$4(is$7.notHash(hash), NO_MARKET_PAIR);
      const subendpoint =
        filterOptions.startDate || filterOptions.endDate ? 'historical' : 'latest';
      return get$7(this.web3data, {
        hash,
  ...
  const {throwIf: throwIf$5, ethFactory: ethFactory$1} = utils$1;
  ...
  const {is: is$9, throwIf: throwIf$6, formatJsonRpc: formatJsonRpc$2} = utils$1;
  ...
  http request to the Amberdata API endpoint.
     ...
     */
    rpc(method, params = []) {
      throwIf$6(!method, ERROR_RPC_NO_METHOD);
      return axios$1
        .post(
