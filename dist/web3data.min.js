...
var n=require("crypto"),t=n.createHash,r=require("./constants"),e=r.ETH_METHODS,o=function(n,t){var r=t.endpoint,e=void 0===r?"":r,o=t.subendpoint,c=void 0===o?"":o,u=t.hash,a=void 0===u?"":u,f=t.pathParam,s=void 0===f?"":f,p=t.filterOptions,m=void 0===p?{}:p,y=d.nonEmptyObject(m)?"?"+i(m):"";return a=a?"/"+a:"",s=s?"/"+s:"",c=c?"/"+c:"",n.rawQuery("".concat(e).concat(a||s).concat(c).concat(y))},i=function(n){var t="";for(var r in n)({}).hasOwnProperty.call(n,r)&&(t+="".concat(r,"=").concat(n[r],"&"));return t},c=function(n,t){if(n)throw new Error(t)},u=function(n){return c(!0,n)},a=function(n){return c(n.error,n.message),this&&this.formatter?this.formatter(n.payload):n.payload},f=function(n){var t=n.response.data;return u(t.message||t.description)},s=function(n,t){if(n)return Promise.reject(new Error(t))},d=function(){};d.string=function(n){return"string"==typeof n},d.bool=function(n){return"boolean"==typeof n},d.emptyString=function(n){return d.string(n)&&0===n.length},d.emptyObject=function(n){return 0===Object.keys(n).length},d.inObject=function(n,t){return Object.prototype.hasOwnProperty.call(n,t)},d.undefined=function(n){return void 0===n},d.null=function(n){return null===n},d.notHash=function(n){return d.undefined(n)||d.emptyString(n)},d.notUndefined=function(n){return!d.undefined(n)},d.nonEmptyObject=function(n){return!d.emptyObject(n)},d.nonEmptyString=function(n){return!d.emptyString(n)},d.notInObject=function(n,t){return!d.inObject(n,t)};var p=function(n){return t("sha1").update(JSON.stringify(n)).digest("base64")},m=function(n){return Object.getOwnPropertyNames(n).filter(function(t){return"function"==typeof n[t]&&"constructor"!==t})},y=function(n){var t={};for(var r in e)({}).hasOwnProperty.call(e,r)&&(t[r]=n[e[r]][r].bind(n[e[r]]));return t},l=function(n,t){return Object.keys(t).forEach(function(r){m(Object.getPrototypeOf(n.web3data[r])).forEach(function(e){t[r].includes(e)&&(n[r]=n[r]?n[r]:{},n[r][e]=n.web3data[r][e].bind(n))})}),n},h=function(n){return n?(n.params&&(n.params=Array.isArray(n.params)?n.params:[n.params]),JSON.stringify({jsonrpc:n.version||"2.0",method:n.method||"subscribe",id:n.id||0,params:n.params||[]})):""},b=function(n,t){return n[t]?n[t]:null},O=function(n){return b(n,"records")};module.exports={buildFilterUrl:i,is:d,throwIf:c,get:o,rejectPromiseIf:s,uuid:p,ethFactory:y,methodFactory:l,throwNow:u,onFulfilled:a,onError:f,formatJsonRpc:h,getMethods:m,recordsFormatter:O};
...
function n(n,t){if(!(n instanceof t))throw new TypeError("Cannot call a class as a function")}function t(n,t){for(var e=0;e<t.length;e++){var i=t[e];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}function e(n,e,i){return e&&t(n.prototype,e),i&&t(n,i),n}var i=require("./constants"),r=i.BLOCKS_ENDPOINT,a=i.ERROR_MESSAGE_BLOCK_NO_ID,o=require("./utils"),u=o.is,s=o.get,l=o.throwIf,c=o.onFulfilled,d=o.onError,f=o.recordsFormatter,b=function(){function t(e){n(this,t),this.web3data=e}return e(t,[{key:"getBlocks",value:function(n){return s(this.web3data,{endpoint:r,filterOptions:n}).then(c.bind({formatter:f}),d)}},{key:"getBlock",value:function(n,t){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,filterOptions:t}).then(c,d)}},{key:"getBlockNumber",value:function(){return this.web3data.block.getBlock("latest").then(function(n){return l(n|!n.number,"Failed to retrieve block number."),parseInt(n.number,10)})}},{key:"getBlockTransactionCount",value:function(n){return this.web3data.block.getBlock(n).then(function(n){return l(!n||!n.predictions&&!n.numTransactions,"Failed to retrieve block transaction count."),n.predictions?null:parseInt(n.numTransactions,10)})}},{key:"getTransactions",value:function(n,t){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"transactions",filterOptions:t}).then(c.bind({formatter:f}),d)}},{key:"getTransactionFromBlock",value:function(n,t){return l(u.undefined(n),a),this.web3data.block.getTransactions(n).then(function(n){return l(!n,"Failed to retrieve transaction."),t<n.length&&t>-1?n[t]:null})}},{key:"getUncle",value:function(n,t){return l(u.undefined(n),a),l(u.undefined(t),"Missing required param 'index'"),this.web3data.block.getBlock(n,{validationMethod:"full"}).then(function(n){return l(!n||!n.predictions&&!n.numTransactions&&!n.validation,"Failed to retrieve uncle."),!n.predictions&&n.validation.uncles&&t<n.validation.uncles.length&&t>-1?n.validation.uncles[t]:null})}},{key:"getTokenTransfers",value:function(n,t){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"token-transfers",filterOptions:t}).then(c,d)}},{key:"getLogs",value:function(n,t){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"logs",filterOptions:t}).then(c.bind({formatter:f}),d)}},{key:"getFunctions",value:function(n,t){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"functions",filterOptions:t}).then(c.bind({formatter:f}),d)}},{key:"getMetrics",value:function(n){return s(this.web3data,{endpoint:r,subendpoint:"metrics/latest",filterOptions:n}).then(c,d)}}]),t}();module.exports=b;
},{"./constants":"p3SI","./utils":"K0yk"}],"6MhD":[function(require,module,exports) {
