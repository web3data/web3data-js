...
var n=this,t=require("crypto"),r=t.createHash,e=require("./constants"),o=e.ETH_METHODS,i=function(n,t){var r=t.endpoint,e=void 0===r?"":r,o=t.subendpoint,i=void 0===o?"":o,u=t.hash,a=void 0===u?"":u,f=t.pathParam,s=void 0===f?"":f,p=t.filterOptions,m=void 0===p?{}:p,y=d.nonEmptyObject(m)?"?"+c(m):"";return a=a?"/"+a:"",s=s?"/"+s:"",i=i?"/"+i:"",n.rawQuery("".concat(e).concat(a||s).concat(i).concat(y))},c=function(n){var t="";for(var r in n)({}).hasOwnProperty.call(n,r)&&(t+="".concat(r,"=").concat(n[r],"&"));return t},u=function(n,t){if(n)throw new Error(t)},a=function(n){return u(!0,n)},f=function(t){return u(t.error,t.message),n&&n.formatter?n.formatter(t):t.payload},s=function(n){var t=n.response.data;return a(t.message||t.description)},p=function(n,t){if(n)return Promise.reject(new Error(t))},d=function(){};d.string=function(n){return"string"==typeof n},d.bool=function(n){return"boolean"==typeof n},d.emptyString=function(n){return d.string(n)&&0===n.length},d.emptyObject=function(n){return 0===Object.keys(n).length},d.inObject=function(n,t){return Object.prototype.hasOwnProperty.call(n,t)},d.undefined=function(n){return void 0===n},d.null=function(n){return null===n},d.notHash=function(n){return d.undefined(n)||d.emptyString(n)},d.notUndefined=function(n){return!d.undefined(n)},d.nonEmptyObject=function(n){return!d.emptyObject(n)},d.nonEmptyString=function(n){return!d.emptyString(n)},d.notInObject=function(n,t){return!d.inObject(n,t)};var m=function(n){return r("sha1").update(JSON.stringify(n)).digest("base64")},y=function(n){return Object.getOwnPropertyNames(n).filter(function(t){return"function"==typeof n[t]&&"constructor"!==t})},l=function(n){var t={};for(var r in o)({}).hasOwnProperty.call(o,r)&&(t[r]=n[o[r]][r].bind(n[o[r]]));return t},b=function(n,t){return Object.keys(t).forEach(function(r){y(Object.getPrototypeOf(n.web3data[r])).forEach(function(e){t[r].includes(e)&&(n[r]=n[r]?n[r]:{},n[r][e]=n.web3data[r][e].bind(n))})}),n},h=function(n){return n?(n.params&&(n.params=Array.isArray(n.params)?n.params:[n.params]),JSON.stringify({jsonrpc:n.version||"2.0",method:n.method||"subscribe",id:n.id||0,params:n.params||[]})):""};module.exports={buildFilterUrl:c,is:d,throwIf:u,get:i,rejectPromiseIf:p,uuid:m,ethFactory:l,methodFactory:b,throwNow:a,onFulfilled:f,onError:s,formatJsonRpc:h,getMethods:y};
...
function n(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}function e(n,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}function t(n,t,i){return t&&e(n.prototype,t),i&&e(n,i),n}var i=require("./constants"),r=i.BLOCKS_ENDPOINT,a=i.ERROR_MESSAGE_BLOCK_NO_ID,o=require("./utils"),u=o.is,s=o.get,l=o.throwIf,c=o.onFulfilled,d=o.onError,f=function(){function e(t){n(this,e),this.web3data=t}return t(e,[{key:"getBlocks",value:function(n){return s(this.web3data,{endpoint:r,filterOptions:n}).then(c,d)}},{key:"getBlock",value:function(n,e){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,filterOptions:e}).then(c,d)}},{key:"getBlockNumber",value:function(){return this.web3data.block.getBlock("latest").then(function(n){return l(n|!n.number,"Failed to retrieve block number."),parseInt(n.number,10)})}},{key:"getBlockTransactionCount",value:function(n){return this.web3data.block.getBlock(n).then(function(n){return l(!n||!n.predictions&&!n.numTransactions,"Failed to retrieve block transaction count."),n.predictions?null:parseInt(n.numTransactions,10)})}},{key:"getTransactions",value:function(n,e){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"transactions",filterOptions:e}).then(c,d)}},{key:"getTransactionFromBlock",value:function(n,e){return l(u.undefined(n),a),this.web3data.block.getTransactions(n).then(function(n){var t=n.records;return l(!t,"Failed to retrieve transaction."),e<t.length&&e>-1?t[e]:null})}},{key:"getUncle",value:function(n,e){return l(u.undefined(n),a),l(u.undefined(e),"Missing required param 'index'"),this.web3data.block.getBlock(n,{validationMethod:"full"}).then(function(n){return l(!n||!n.predictions&&!n.numTransactions&&!n.validation,"Failed to retrieve uncle."),!n.predictions&&n.validation.uncles&&e<n.validation.uncles.length&&e>-1?n.validation.uncles[e]:null})}},{key:"getTokenTransfers",value:function(n,e){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"token-transfers",filterOptions:e}).then(c,d)}},{key:"getLogs",value:function(n,e){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"logs",filterOptions:e}).then(c,d)}},{key:"getFunctions",value:function(n,e){return l(u.undefined(n),a),s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"functions",filterOptions:e}).then(c,d)}},{key:"getMetrics",value:function(n){return s(this.web3data,{endpoint:r,subendpoint:"metrics/latest",filterOptions:n}).then(c,d)}}]),e}();module.exports=f;
