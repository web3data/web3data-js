...
function n(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}function e(n,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,i.key,i)}}function t(n,t,i){return t&&e(n.prototype,t),i&&e(n,i),n}var i=require("./constants"),r=i.BLOCKS_ENDPOINT,o=i.ERROR_MESSAGE_BLOCK_NO_ID,a=require("./utils"),u=a.is,s=a.get,l=a.throwIf,c=a.onFulfilled,d=a.onError,f=function(){function e(t){n(this,e),this.web3data=t}return t(e,[{key:"getBlocks",value:function(n){return s(this.web3data,{endpoint:r,filterOptions:n}).then(c,d)}},{key:"getBlock",value:function(n,e){return l(u.undefined(n),o),s(this.web3data,{pathParam:n,endpoint:r,filterOptions:e}).then(c,d)}},{key:"getBlockNumber",value:function(){return this.web3data.block.getBlock("latest").then(function(n){return l(n|!n.number,"Failed to retrieve block number."),parseInt(n.number,10)})}},{key:"getBlockTransactionCount",value:function(n){return this.web3data.block.getBlock(n).then(function(n){return l(!n||!n.predictions&&!n.numTransactions,"Failed to retrieve block transaction count."),n.predictions?null:parseInt(n.numTransactions,10)})}},{key:"getTransactions",value:function(n,e){return l(u.undefined(n),o),s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"transactions",filterOptions:e}).then(c,d)}},{key:"getTransactionFromBlock",value:function(n,e){return l(u.undefined(n),o),this.web3data.block.getTransactions(n).then(function(n){var t=n.records;return l(!t,"Failed to retrieve transaction."),e<t.length&&e>-1?t[e]:null})}},{key:"getUncle",value:function(n,e){return l(u.undefined(n),o),l(u.undefined(e),"Missing required param 'index'"),this.web3data.block.getBlock(n,{validationMethod:"full"}).then(function(n){return l(!n||!n.predictions&&!n.numTransactions&&!n.validation,"Failed to retrieve uncle."),!n.predictions&&n.validation.uncles&&e<n.validation.uncles.length&&e>-1?n.validation.uncles[e]:null})}},{key:"getTokenTransfers",value:function(n,e){return u.undefined(n)?Promise.reject(new Error(o)):s(this.web3data,{pathParam:n,endpoint:r,subendpoint:"token-transfers",filterOptions:e}).then(function(n){return n.error?l(!0,n.message):n.payload},function(n){return l(!0,n.response.data.message)})}},{key:"getLogs",value:function(n,e){return l(u.notHash(n),o),s(this.web3data,{id:n,endpoint:r,subendpoint:"logs",filterOptions:e}).then(c,d)}},{key:"getFunctions",value:function(n,e){return l(u.notHash(n),o),s(this.web3data,{id:n,endpoint:r,subendpoint:"functions",filterOptions:e}).then(c,d)}},{key:"getMetrics",value:function(n){return s(this.web3data,{endpoint:r,subendpoint:"metrics/latest",filterOptions:n}).then(c,d)}}]),e}();module.exports=f;
