...
"use strict";var e=t(require("@babel/runtime/regenerator"));function t(e){return e&&e.__esModule?e:{default:e}}function n(e,t,n,r,a,i,o){try{var u=e[i](o),s=u.value}catch(c){return void n(c)}u.done?t(s):Promise.resolve(s).then(r,a)}function r(e){return function(){var t=this,r=arguments;return new Promise(function(a,i){var o=e.apply(t,r);function u(e){n(o,a,i,u,s,"next",e)}function s(e){n(o,a,i,u,s,"throw",e)}u(void 0)})}}function a(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function i(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function o(e,t,n){return t&&i(e.prototype,t),n&&i(e,n),e}var u=require("./constants"),s=u.BLOCKS_ENDPOINT,c=u.ERROR_MESSAGE_BLOCK_NO_ID,l=require("./utils"),f=l.is,d=l.get,p=l.throwIf,h=l.onFulfilled,v=l.onError,b=function(){function t(e){a(this,t),this.web3data=e}return o(t,[{key:"getBlocks",value:function(e){return d(this.web3data,{endpoint:s,filterOptions:e}).then(h,v)}},{key:"getBlock",value:function(e,t){return p(f.undefined(e),c),d(this.web3data,{pathParam:e,endpoint:s,filterOptions:t}).then(h,v)}},{key:"getBlockNumber",value:function(){var t=r(e.default.mark(function t(){var n;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,this.web3data.block.getBlock("latest");case 2:return n=e.sent,p(n|!n.number,"Failed to retrieve block number."),e.abrupt("return",parseInt(n.number,10));case 5:case"end":return e.stop()}},t,this)}));return function(){return t.apply(this,arguments)}}()},{key:"getBlockTransactionCount",value:function(){var t=r(e.default.mark(function t(n){var r;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,this.web3data.block.getBlock(n);case 2:return r=e.sent,p(!r||!r.predictions&&!r.numTransactions,"Failed to retrieve block transaction count."),e.abrupt("return",r.predictions?null:parseInt(r.numTransactions,10));case 5:case"end":return e.stop()}},t,this)}));return function(e){return t.apply(this,arguments)}}()},{key:"getTransactions",value:function(e,t){return p(f.undefined(e),c),d(this.web3data,{pathParam:e,endpoint:s,subendpoint:"transactions",filterOptions:t}).then(h,v)}},{key:"getTransactionFromBlock",value:function(e,t){return p(f.undefined(e),c),this.web3data.block.getTransactions(e).then(function(e){var n=e.records;return p(!n,"Failed to retrieve transaction."),t<n.length&&t>-1?n[t]:null},v)}},{key:"getUncle",value:function(){var t=r(e.default.mark(function t(n,r){var a;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,this.web3data.block.getBlock(n,{validationMethod:"full"});case 2:return a=e.sent,e.abrupt("return",new Promise(function(e,t){a&&(a.predictions||a.numTransactions||a.validation)?a.predictions||!a.validation.uncles?e(null):r<a.validation.uncles.length&&r>-1?e(a.validation.uncles[r]):e(null):t(new Error("Failed to retrieve uncle."))}));case 4:case"end":return e.stop()}},t,this)}));return function(e,n){return t.apply(this,arguments)}}()},{key:"getTokenTransfers",value:function(e,t){return f.undefined(e)?Promise.reject(new Error(c)):d(this.web3data,{pathParam:e,endpoint:s,subendpoint:"token-transfers",filterOptions:t}).then(function(e){return e.error?p(!0,e.message):e.payload},function(e){return p(!0,e.response.data.message)})}},{key:"getLogs",value:function(e,t){return p(f.notHash(e),c),d(this.web3data,{id:e,endpoint:s,subendpoint:"logs",filterOptions:t}).then(h,v)}},{key:"getFunctions",value:function(e,t){return p(f.notHash(e),c),d(this.web3data,{id:e,endpoint:s,subendpoint:"functions",filterOptions:t}).then(h,v)}},{key:"getMetrics",value:function(e){return d(this.web3data,{endpoint:s,subendpoint:"metrics/latest",filterOptions:e}).then(h,v)}}]),t}();module.exports=b;
