...
function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function n(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}var i=require("./constants"),r=i.TRANSACTIONS_ENDPOINT,a=i.ERROR_MESSAGE_TRANSACTION_NO_HASH,o=require("./utils"),u=o.is,s=o.get,c=o.onFulfilled,l=o.onError,d=o.throwIf,f=function(){function t(n){e(this,t),this.web3data=n}return n(t,[{key:"getTransactions",value:function(e){return s(this.web3data,{endpoint:r,filterOptions:e}).then(c,l)}},{key:"getTransaction",value:function(e,t){return d(u.notHash(e),a),s(this.web3data,{pathParam:e,endpoint:r,filterOptions:t}).then(c,l)}},{key:"getPendingTransactions",value:function(){return this.getTransactions({status:"pending"}).then(function(e){return d(u.undefined(e)||u.null(e),"Failed to retrieve pending transactions."),e},console.error)}},{key:"getGasPrediction",value:function(){return s(this.web3data,{endpoint:r,subendpoint:"gas/predictions"}).then(c,l)}},{key:"getGasPrice",value:function(){return this.getGasPrediction().then(function(e){return d(!e.average||!e.average.gasPrice,"Failed to retrieve gas price."),"".concat(e.average.gasPrice)})}},{key:"getVolume",value:function(e){return s(this.web3data,{endpoint:r,subendpoint:"volume",filterOptions:e}).then(c,l)}},{key:"getMetrics",value:function(e){return s(this.web3data,{endpoint:r,subendpoint:"metrics/latest",filterOptions:e}).then(c,l)}}]),t}();module.exports=f;
