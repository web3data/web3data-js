...
var n=require("crypto"),r=require("./constants"),t=r.ETH_METHODS,e=function(n,r){var t=r.endpoint,e=void 0===t?"":t,i=r.subendpoint,u=void 0===i?"":i,a=r.hash,c=void 0===a?"":a,s=r.pathParam,p=void 0===s?"":s,d=r.filterOptions,m=void 0===d?{}:d,l=f.nonEmptyObject(m)?"?"+o(m):"";return c=c?"/"+c:"",p=p?"/"+p:"",u=u?"/"+u:"",n.rawQuery("".concat(e).concat(c||p).concat(u).concat(l))},o=function(n){var r="";for(var t in n)({}).hasOwnProperty.call(n,t)&&(r+="".concat(t,"=").concat(n[t],"&"));return r},i=function(n,r){if(n)throw new Error(r)},u=function(n){return i(!0,n)},a=function(n){return n.error?u(n.message):n.payload},c=function(n){return u(n.response.data.message)},s=function(n,r){if(n)return Promise.reject(new Error(r))},f=function(){};f.string=function(n){return"string"==typeof n},f.bool=function(n){return"boolean"==typeof n},f.emptyString=function(n){return f.string(n)&&0===n.length},f.emptyObject=function(n){return 0===Object.keys(n).length},f.inObject=function(n,r){return Object.prototype.hasOwnProperty.call(n,r)},f.undefined=function(n){return void 0===n},f.null=function(n){return null===n},f.notHash=function(n){return f.undefined(n)||f.emptyString(n)},f.notUndefined=function(n){return!f.undefined(n)},f.nonEmptyObject=function(n){return!f.emptyObject(n)},f.nonEmptyString=function(n){return!f.emptyString(n)},f.notInObject=function(n,r){return!f.inObject(n,r)};var p=function(r){return n.createHash("sha1").update(JSON.stringify(r)).digest("base64")},d=function(n){var r={};for(var e in t)({}).hasOwnProperty.call(t,e)&&(r[e]=n[t[e]][e].bind(n[t[e]]));return r},m=function(n){return n?(n.params&&(n.params=Array.isArray(n.params)?n.params:[n.params]),JSON.stringify({jsonrpc:n.version||"2.0",method:n.method||"subscribe",id:n.id||0,params:n.params||[]})):""};module.exports={buildFilterUrl:o,is:f,throwIf:i,get:e,rejectPromiseIf:s,uuid:p,ethFactory:d,throwNow:u,onFulfilled:a,onError:c,formatJsonRpc:m};
