...
"use strict";var t=e(require("@babel/runtime/regenerator"));function e(t){return t&&t.__esModule?t:{default:t}}function n(t,e,n,r,a,i,o){try{var u=t[i](o),s=u.value}catch(c){return void n(c)}u.done?e(s):Promise.resolve(s).then(r,a)}function r(t){return function(){var e=this,r=arguments;return new Promise(function(a,i){var o=t.apply(e,r);function u(t){n(o,a,i,u,s,"next",t)}function s(t){n(o,a,i,u,s,"throw",t)}u(void 0)})}}function a(t,e){if(!(t instanceof e))throw new TypeError("Cannot call a class as a function")}function i(t,e){for(var n=0;n<e.length;n++){var r=e[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(t,r.key,r)}}function o(t,e,n){return e&&i(t.prototype,e),n&&i(t,n),t}var u=require("./utils"),s=u.is,c=u.get,d=u.throwIf,l=u.onFulfilled,p=u.onError,f=require("./constants"),h=f.MARKET_ENDPOINT,v=f.ERROR_MESSAGE_MARKET_NO_PAIR,b=function(){function e(t){a(this,e),this.web3data=t}return o(e,[{key:"getEtherPrice",value:function(){var e=r(t.default.mark(function e(){var n;return t.default.wrap(function(t){for(;;)switch(t.prev=t.next){case 0:return t.next=2,c(this.web3data,{endpoint:h+"/prices/eth/latest"});case 2:return n=t.sent,d(!n||200!==n.status||!n.payload,"Failed to retrieve Ether price."),t.abrupt("return",n.payload);case 5:case"end":return t.stop()}},e,this)}));return function(){return e.apply(this,arguments)}}()},{key:"getRankings",value:function(t){return c(this.web3data,{endpoint:h,subendpoint:"rankings",filterOptions:t}).then(l,p)}},{key:"getOhlcv",value:function(t){var e=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};d(s.undefined(t),v);var n=e.startDate||e.endDate?"historical":"latest";return c(this.web3data,{pathParam:t,endpoint:"".concat(h,"/ohlcv"),subendpoint:n,filterOptions:e}).then(l,p)}},{key:"getOrders",value:function(t,e){return d(s.undefined(t),v),c(this.web3data,{pathParam:t,endpoint:"".concat(h,"/orders"),filterOptions:e}).then(l,p)}},{key:"getBbos",value:function(t,e){return d(s.undefined(t),v),c(this.web3data,{pathParam:t,endpoint:"".concat(h,"/orders"),subendpoint:"bbo",filterOptions:e}).then(l,p)}},{key:"getPrices",value:function(t,e){d(s.undefined(t),v);var n=e.startDate||e.endDate?"historical":"latest";return c(this.web3data,{pathParam:t,endpoint:"".concat(h,"/prices"),subendpoint:n,filterOptions:e}).then(l,p)}},{key:"getTokenPrices",value:function(t,e){d(s.notHash(t),v);var n=e.startDate||e.endDate?"historical":"latest";return c(this.web3data,{hash:t,endpoint:"".concat(h,"/tokens/prices"),subendpoint:n,filterOptions:e}).then(l,p)}},{key:"getVwap",value:function(t,e){return d(s.undefined(t),v),c(this.web3data,{pathParam:t,endpoint:"".concat(h,"/prices"),subendpoint:"wap/latest",filterOptions:e}).then(l,p)}},{key:"getTickers",value:function(t,e){d(s.undefined(t),v);var n=e.startDate||e.endDate?"historical":"latest";return c(this.web3data,{pathParam:t,endpoint:"".concat(h,"/tickers"),subendpoint:n,filterOptions:e}).then(l,p)}},{key:"getTrades",value:function(t,e){return d(s.undefined(t),v),c(this.web3data,{pathParam:t,endpoint:"".concat(h,"/trades"),subendpoint:"historical",filterOptions:e}).then(l,p)}}]),e}();module.exports=b;
