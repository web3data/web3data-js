...
function e(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function t(e,t){for(var n=0;n<t.length;n++){var i=t[n];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(e,i.key,i)}}function n(e,n,i){return n&&t(e.prototype,n),i&&t(e,i),e}var i=require("./constants"),r=i.TRANSACTIONS_ENDPOINT,a=i.ERROR_MESSAGE_TRANSACTION_NO_HASH,o=require("./utils"),s=o.is,u=o.get,l=o.onFulfilled,c=o.onError,d=o.throwIf,f=function(){function t(n){e(this,t),this.web3data=n}return n(t,[{key:"getTransactions",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return u(this.web3data,{endpoint:r,filterOptions:e}).then(l,c)}},{key:"getTransaction",value:function(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};return d(s.notHash(e),a),u(this.web3data,{pathParam:e,endpoint:r,filterOptions:t}).then(l,c)}},{key:"getPendingTransactions",value:function(){return this.getTransactions({status:"pending"}).then(function(e){return d(s.undefined(e)||s.null(e),"Failed to retrieve pending transactions."),e},console.error)}},{key:"getGasPrediction",value:function(){return u(this.web3data,{endpoint:r,subendpoint:"gas/predictions"}).then(l,c)}},{key:"getGasPercentiles",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return u(this.web3data,{endpoint:r,subendpoint:"gas/percentiles",filterOptions:e}).then(l,c)}},{key:"getGasPrice",value:function(){return this.getGasPrediction().then(function(e){return d(!e.average||!e.average.gasPrice,"Failed to retrieve gas price."),"".concat(e.average.gasPrice)})}},{key:"getVolume",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return u(this.web3data,{endpoint:r,subendpoint:"volume",filterOptions:e}).then(l,c)}},{key:"getMetrics",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:{};return u(this.web3data,{endpoint:r,subendpoint:"metrics/latest",filterOptions:e}).then(l,c)}}]),t}();module.exports=f;
},{"./constants":"p3SI","./utils":"K0yk"}],"Daw0":[function(require,module,exports) {
