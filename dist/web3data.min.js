...
},{"regenerator-runtime":"jsKO"}],"hRTX":[function(require,module,exports) {
...
},{"process-nextick-args":"iFTO","isarray":"aq/z","events":"wIHY","./internal/streams/stream":"o232","safe-buffer":"gI/y","core-util-is":"kj8s","inherits":"oxw+","util":"sC8V","./internal/streams/BufferList":"m36/","./internal/streams/destroy":"Umu+","./_stream_duplex":"6gYn","string_decoder/":"ikue","process":"g5I+"}],"PxOV":[function(require,module,exports) {
...
},{"buffer":"sC8V"}],"En1q":[function(require,module,exports) {
...
},{"crypto":"sC8V"}],"vItx":[function(require,module,exports) {
...
},{"bn.js":"7o7R","../../elliptic":"0G54"}],"JBz3":[function(require,module,exports) {
...
},{"../curve":"3fmn","../../elliptic":"0G54","bn.js":"7o7R","inherits":"oxw+"}],"iBD7":[function(require,module,exports) {
...
},{"../curve":"3fmn","bn.js":"7o7R","inherits":"oxw+","../../elliptic":"0G54"}],"5zAD":[function(require,module,exports) {
...
},{"../curve":"3fmn","../../elliptic":"0G54","bn.js":"7o7R","inherits":"oxw+"}],"3fmn":[function(require,module,exports) {
...
},{"hash.js":"U6lo","../elliptic":"0G54","./precomputed/secp256k1":"fjH+"}],"kwdl":[function(require,module,exports) {
...
},{"bn.js":"7o7R","../../elliptic":"0G54"}],"7vm1":[function(require,module,exports) {
...
},{"bn.js":"7o7R","../../elliptic":"0G54"}],"Tbty":[function(require,module,exports) {
...
},{"bn.js":"7o7R","hmac-drbg":"kwdl","../../elliptic":"0G54","./key":"FvtJ","./signature":"7vm1"}],"uUCk":[function(require,module,exports) {
...
},{"../../elliptic":"0G54"}],"Fvj4":[function(require,module,exports) {
...
},{"bn.js":"7o7R","../../elliptic":"0G54"}],"td2I":[function(require,module,exports) {
...
},{"hash.js":"U6lo","../../elliptic":"0G54","./key":"uUCk","./signature":"Fvj4"}],"0G54":[function(require,module,exports) {
...
},{"../package.json":"Y4Tp","./elliptic/utils":"hLmj","brorand":"En1q","./elliptic/curve":"3fmn","./elliptic/curves":"6Yey","./elliptic/ec":"Tbty","./elliptic/eddsa":"td2I"}],"IVhz":[function(require,module,exports) {
...
},{"indexof":"IVhz"}],"WF4J":[function(require,module,exports) {
...
},{"crypto":"WnIQ"}],"04iW":[function(require,module,exports) {
...
},{"./utils":"K0yk","./constants":"p3SI"}],"M3qd":[function(require,module,exports) {
...
},{"./constants":"p3SI","./utils":"K0yk"}],"QtjS":[function(require,module,exports) {
...
},{"./utils":"K0yk","./constants":"p3SI"}],"6MhD":[function(require,module,exports) {
...
},{"./utils":"K0yk","./constants":"p3SI"}],"Z0pR":[function(require,module,exports) {
var global = arguments[3];
...
"use strict";Object.defineProperty(exports,"__esModule",{value:!0}),exports.default=void 0;var e=require("./constants"),t=require("./utils");function s(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function r(e,t){for(var s=0;s<t.length;s++){var r=t[s];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function n(e,t,s){return t&&r(e.prototype,t),s&&r(e,s),e}var i=require("isomorphic-ws"),o=function(e){return e?(e.params&&(e.params=Array.isArray(e.params)?e.params:[e.params]),JSON.stringify({jsonrpc:e.version||"2.0",method:e.method||"subscribe",id:e.id||0,params:e.params||[]})):""},c=function(e){return!e.params},a=3,u=18e4,l=5e3,d=function(){function r(t,n){return s(this,r),this.socket=null,this.baseWsUrl=n&&n.websocketUrl?n.websocketUrl:e.DEFAULT_WEBSOCKET_URL,console.log(this.baseWsUrl),this.apiKey=t,this.connected=!1,this.reconnects=0,this.responseReceived=!1,this.dataReceived=!1,this.registry={},this.registrySubIds={},this.latestState={},this}return n(r,[{key:"connect",value:function(e){var s=this;if(t.is.null(this.socket))return this.socket=new i("".concat(this.baseWsUrl,"?x-api-key=").concat(this.apiKey)),this.socket.addEventListener("open",function(r){console.log("websocket client connection opened"),s.connected=!0,s._refreshSubscriptions(),s._listen(),e&&e(r),setTimeout(function(){!s.responseReceived&&t.is.nonEmptyObject(s.registry)&&s.socket&&s.socket.close()},l),setTimeout(function(){!s.dataReceived&&t.is.nonEmptyObject(s.registry)&&s.socket.close()},u)}),this.socket.addEventListener("error",function(t){e&&t?e(t):console.error("connection error occurred"),console.error("connection error occurred"),s._reconnect()}),this.socket.addEventListener("close",function(e){console.log("Websocket client connection closed - code",e.code),s._reconnect()}),this}},{key:"disconnect",value:function(){var e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:null;this.socket&&1===this.socket.readyState?(this.socket.onclose=e?function(){return e("Websocket client connection closed")}:function(){return console.log("Websocket client connection closed")},this.socket.close(),this.socket=null):console.error("socket is not yet connected")}},{key:"on",value:function(e,s){var r=e.eventName,n=e.filters;if(s||console.warn("no callback provided"),r){var i=(0,t.uuid)({eventName:r,filters:n});this.connected&&this._subscribe(r,n),this.registry[i]={},this.registry[i].callback=s,this.registry[i].args={eventName:r,filters:n}}else console.error("no event specified")}},{key:"off",value:function(e,s){var r=e.eventName,n=e.filters;if(s||console.warn("no callback provided"),r){var i=this._unsubscribe(r,n);t.is.notUndefined(this.registry[i])&&delete this.registry[i],s("successfully unsubscribed")}else console.error("no event specified")}},{key:"_reconnect",value:function(){this.connected&&this.disconnect(),++this.reconnects<=a&&(console.log("attempting to reconnect...".concat(this.reconnects,"/").concat(a)),this.connect())}},{key:"_refreshSubscriptions",value:function(){if(this.registry)for(var e=Object.values(this.registry),t=0;t<e.length;t++){var s=e[t].args,r=s.eventName,n=s.filters;this._subscribe(r,n)}}},{key:"_listen",value:function(){var e=this;this.socket.addEventListener("message",function(s){var r;try{r=JSON.parse(s.data)}catch(u){return void console.error("error parsing json request")}if(e.responseReceived=!0,c(r)){var n=r&&r.id?r.id:"";e.registrySubIds[r.result]=n,e.registry[n].subId=r.result}else{e.dataReceived=!0;var i=r&&r.params&&r.params.result?r.params.result:{},o=r&&r.params&&r.params.subscription?r.params.subscription:"",a=e.registrySubIds[o];t.is.notUndefined(e.registry[a])&&e.registry[a].callback(i),t.is.notUndefined(e.latestState[a])&&(e.latestState[a]=i)}})}},{key:"_subscribe",value:function(e,s){var r=t.is.notUndefined(s)?[s]:[],n=(0,t.uuid)({eventName:e,filters:s}),i=o({id:n,params:[e].concat(r)});return this.socket.send(i),n}},{key:"_unsubscribe",value:function(e,s){var r=(0,t.uuid)({eventName:e,filters:s});if(this.registry[r]&&this.registry[r].subId){var n=o({id:r,method:"unsubscribe",params:[this.registry[r].subId]});return this.socket.readyState===this.socket.OPEN&&this.socket.send(n),r}console.error("Not subscribed to: '".concat(e,"'"))}}]),r}(),h=d;exports.default=h;
},{"./constants":"p3SI","./utils":"K0yk","isomorphic-ws":"Z0pR"}],"cNXC":[function(require,module,exports) {
"use strict";var e=f(require("@babel/runtime/regenerator")),t=f(require("axios")),n=require("./constants"),r=require("./utils"),i=f(require("./address")),s=f(require("./token")),o=f(require("./contract")),a=f(require("./transaction")),c=f(require("./block")),u=f(require("./signature")),l=f(require("./websocket"));function f(e){return e&&e.__esModule?e:{default:e}}function h(e,t,n,r,i,s,o){try{var a=e[s](o),c=a.value}catch(u){return void n(u)}a.done?t(c):Promise.resolve(c).then(r,i)}function d(e){return function(){var t=this,n=arguments;return new Promise(function(r,i){var s=e.apply(t,n);function o(e){h(s,r,i,o,a,"next",e)}function a(e){h(s,r,i,o,a,"throw",e)}o(void 0)})}}function w(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function v(e,t){for(var n=0;n<t.length;n++){var r=t[n];r.enumerable=r.enumerable||!1,r.configurable=!0,"value"in r&&(r.writable=!0),Object.defineProperty(e,r.key,r)}}function b(e,t,n){return t&&v(e.prototype,t),n&&v(e,n),e}var k=function(){function f(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{};w(this,f),(0,r.throwIf)(r.is.undefined(e)||r.is.emptyString(e),"No api key supplied"),this.apiKey=e,this.headers={},this.headers[n.API_KEY_HEADER]=this.apiKey,t.blockchainId&&(this.headers[n.BLOCKCHAIN_ID_HEADER]=t.blockchainId),this.wsConfig={websocketUrl:t.websocketUrl?t.websocketUrl:null},this.baseUrl=t.baseUrl?t.baseUrl:n.DEFAULT_BASE_URL,this.address=new i.default(this),this.token=new s.default(this),this.contract=new o.default(this),this.transaction=new a.default(this),this.block=new c.default(this),this.signature=new u.default(this),this.websocket=null}return b(f,[{key:"connect",value:function(e){return this.websocket=this.websocket?this.websocket:new l.default(this.apiKey,this.wsConfig),this.websocket.connect(e)}},{key:"disconnect",value:function(e){this.websocket?this.websocket.disconnect(e):console.error("socket is not yet connected")}},{key:"on",value:function(e,t){var n=e.eventName,r=e.filters;t||console.warn("no callback provided"),n?this.websocket.on({eventName:n,filters:r},t):console.error("no event specified")}},{key:"off",value:function(e,t){var n=e.eventName,r=e.filters;t||console.warn("no callback provided"),n?this.websocket.off({eventName:n,filters:r},t):console.error("no event specified")}},{key:"rawQuery",value:function(){var n=d(e.default.mark(function n(r){var i;return e.default.wrap(function(e){for(;;)switch(e.prev=e.next){case 0:return e.next=2,t.default.get(this.baseUrl+r,{headers:this.headers});case 2:return i=e.sent,e.abrupt("return",i.data);case 4:case"end":return e.stop()}},n,this)}));return function(e){return n.apply(this,arguments)}}()}]),f}();module.exports=k;
},{"@babel/runtime/regenerator":"8m4e","axios":"O4Aa","./constants":"p3SI","./utils":"K0yk","./address":"04iW","./token":"54Z5","./contract":"M3qd","./transaction":"QtjS","./block":"Daw0","./signature":"6MhD","./websocket":"fNQe"}],"Focm":[function(require,module,exports) {
