...
test(returnsObjectWithField, {blockchain: 'eth', field: 'topics', method: 'eth_getLogs', params: [{"blockHash": "0x7c5a35e9cb3e8ae0e221ab470abae9d446c3a5626ce6689fc777dcffcab52c70", "topics":["0x241ea03ca20251805084d27d4440371c34a0b85ff108f6bb5611248f73818b80"]}] })
...
test(returnsResultAsHex, {blockchain: 'btc', method: 'getbestblockhash'})
test(returnsObjectWithField, {blockchain: 'btc', field: 'hash', method: 'getblock', params: ["00000000000000000000e16f42aa65970c1e0be9063b4898806d9e31aee4e005"]})
test(returnsObjectWithField, {blockchain: 'btc', field: 'chain', method: 'getblockchaininfo'})
test(returnsResultAsHex, {blockchain: 'btc', method: "getblockhash", params: [ /* block number */ 594413 ]})
test(returnsObjectWithField, {blockchain: 'btc', field: 'hash', method: "getblockheader", params: [ "000000000000000000187f49c0f588440af52039bc6e5951c286b692af2d004d" ]})
test(returnsObjectWithField, {blockchain: 'btc', field: 'avgfee', method: "getblockstats", params: [ "000000000000000000187f49c0f588440af52039bc6e5951c286b692af2d004d" ]})
test(returnsObjectWithField, {blockchain: 'btc', field: 'branchlen', method: "getchaintips"})
test(returnsObjectWithField, {blockchain: 'btc', field: 'time', method: "getchaintxstats"})
test(returnsNumber, {blockchain: 'btc', method: "getconnectioncount"})
test(returnsNumber, {blockchain: 'btc', method: "getdifficulty"})
...
test('Successfully calls getmempoolancestors', async t => {
...
test('Successfully calls getmempooldescendants', async t => {
    let rpcResp = await t.context.web3data.btc.rpc('getrawmempool')
    const mempool = rpcResp.result
...
test('Successfully calls getmempoolentry', async t => {
    let rpcResp = await t.context.web3data.btc.rpc('getrawmempool')
    const mempool = rpcResp.result
...
test(returnsObjectWithField, {blockchain: 'btc', field: 'size', method: "getmempoolinfo"})
test(returnsNumber, {blockchain: 'btc', method: "getnetworkhashps"})
test(returnsResultAsHex, {blockchain: 'btc', method: "getrawtransaction", params: ["6b029135dcbff2c9bba177b3875542c1a5d0c8ffa6f889658b14ff9d97487b0a"]})
test(returnsObjectWithField, {blockchain: 'btc', field: 'bestblock', method: "gettxout", params: ["bed356f45cdfadbd77b38440add1bf0b1e95bc9916cd51a594962c05c90a9f5c", 0]})
test(returnsResultAsHex, {blockchain: 'btc', method: "gettxoutproof", params: [["73969cb14bda9cdcf1c0f96b3e3d0941caf44b7328bba89b0e7c6d31ea710894"]] })
