...
class Web3Data {
  ...
  logs(logHash) {
    if (arguments.length === 0) {
      ...
      this.url += `/logs/${logHash}` // ?? endpoint not clear see: https://github.com/amberdata/data-api#get-addresshashlogs
    }
    return this
  }
  ...
  messages(messageHash) {
    if (arguments.length === 0) {
      ...
      this.url += `/functions/${messageHash}`// ?? endpoint not clear see: https://github.com/amberdata/data-api#get-addresshashfunctions
    }
    return this
  }
